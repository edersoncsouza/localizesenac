...
include('../dist/php/seguranca.php'); // Inclui o arquivo com o sistema de segurança
	...
	// monta a query de pesquisa de lembretes do pemail
	$sqlPesquisa = "SELECT
				aluno_lembrete.id
			FROM
	...
	// EXCLUI OS LEMBRETES DO pemail DA TABELA aluno_lembrete
	if(mysql_num_rows($resultPesquisa) != 0){ // se encontrou lembretes pemail para o aluno
