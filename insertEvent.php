...
<?php
	...
	// verifica se recebeu os parametros por POST
		if(isset($_POST['unidade'], $_POST['turno'], $_POST['dia'], $_POST['sala'], $_POST['disciplina'])){
			...
			$diaAtual = date('Y-m-dTH:i:s'); // define a mascara da data e hora
			echo $diaAtual; // exibe a data e hora 
			echo "<BR> Dia recebido como parametro: ". $dia . "<br>";
			echo "Data passada para pegar dia da semana: " . substr($diaAtual,0,10);
			echo getDiaSemana($diaAtual.substr(0,10));
		}
		...
		*/
		...
		$start = new Google_Service_Calendar_EventDateTime(); // cria o servico do calendar
