...
include("../dist/php/seguranca.php"); // Inclui o arquivo com o sistema de segurança
	...
	//echo "O numero de lembretes google e: " . mysql_num_rows($result) . "\n";
	
	if(mysql_num_rows($result) > 0){ // se houverem lembretes do tipo google (sms ou email)
