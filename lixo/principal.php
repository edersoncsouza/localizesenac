...
<html lang="pt-br">
	...
	<script type="text/javascript" src="script/instrucao.js"></script>
        ...
        <script>
            function atualizaAndar(int andar) {
            alert ("Entrei");
        ...
        <?php
                function atualizaOutrosServicos(){
                echo "<p>";
    ...
    <body>
        <div class="container-fluid principal">
            ...
            <div class="row menuPesquisas">
                ...
                <div class="col-md-3 blocoPesquisa">
                ...
                <div class="col-md-9 blocoExtras">
                    <div class="row linhaExtras">   

                        <div class="col-md-3 subBloco_outrosServicos">
                        ...
                        <div class="col-md-4 subBloco_EventosSenac">
                        ...
                        <div class="col-md-5 subBloco_MinhasAulas" id="postit">
...
<!--                                <img class="mapa" src="images/1andar.jpg" alt="primeiro andar">-->
        ...
        <footer class="navbar-default <!-- navbar-fixed-bottom .hidden-phone--> ">
...
<!-- inicio do novo metodo par ao stick footer -->

<div id="footer" class="container">
    <nav class="navbar navbar-default navbar-fixed-bottom">
        <div class="navbar-inner navbar-content-center">

            <p class="text-muted credit">© 2010 Senac-RS - Todos os direitos Reservados.</p>
                <p class="text-muted credit">Serviço Nacional de Aprendizagem Comercial do Rio Grande do Sul - Senac-RS </p>
        </div>
    </nav>
</div>
            </div>
...
<!-- final do novo metodo par ao stick footer -->
