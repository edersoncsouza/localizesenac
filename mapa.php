...
<body onload="resetPanel();">
	<div id="map">
		...
		<div id="painel" class="leaflet-info-pane" hidden>
	...
	<script type="text/javascript">
		...
		*/
		...
		function resetPanel(){
			// apaga o painel de informacoes e adiciona informacoes da faculdade
...
$.getJSON("data/data.json", function(geoJSON) {
	...
	atualizaPainel(layer.feature.properties.tags);
		...
		// metodo alternativo para criacao da legenda do mapa
